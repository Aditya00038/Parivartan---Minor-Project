...
export const ALL_LANGUAGE_OPTIONS: LanguageOption[] = [
  ...
  { code: 'mi', label: 'Maori', nativeLabel: 'Te Reo Māori' },
  { code: 'mn', label: 'Mongolian', nativeLabel: 'Монгол' },
  { code: 'my', label: 'Myanmar (Burmese)', nativeLabel: 'မြန်မာ' },
...
export const GOOGLE_TRANSLATE_LANGUAGE_CODES = new Set(ALL_LANGUAGE_OPTIONS.map((language) => language.code));